...
layout = [  [sg.Text("Welcome to my Overwatch Stats Program", font = ("Helvetica", 40) )], 
            [sg.Button("Exit", size = (20, 10), font = ("Helvetica", 20) ), sg.Button("See Stats", size = (20, 10), font = ("Helvetica", 20) ), sg.Button("Add Game", size = (20, 10), font = ("Helvetica, 20") )] ]
...
# everything below this comment will eventually be functions
